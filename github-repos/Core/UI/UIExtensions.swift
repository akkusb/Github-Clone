...
extension UIView {
    ...
    func getConstraintWithAttribute(attribute:NSLayoutConstraint.Attribute) -> NSLayoutConstraint?
    {
    ...
    func setConstantWithConstraintAttribute(constant:Float,attribute:NSLayoutConstraint.Attribute)
    {
